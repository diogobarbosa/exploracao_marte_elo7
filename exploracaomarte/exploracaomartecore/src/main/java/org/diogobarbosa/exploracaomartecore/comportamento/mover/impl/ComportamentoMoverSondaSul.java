...
public class ComportamentoMoverSondaSul extends ComportamentoMoverSondaAbstrata {

	public Coordenada moverSonda(Coordenada coordenadaAtual, DirecaoOrientacaoSondaEnum orientacaoAtualSondaEnum) {

		if (orientacaoAtualSondaEnum.equals(DirecaoOrientacaoSondaEnum.DIRECAO_SUL)) {
