...
public class ComportamentoGirarSondaDireita extends ComportamentoGirarSondaAbstrata {
	...
	public DirecaoOrientacaoSondaEnum girarSonda(DirecaoGiroSondaEnum direcaoGiroSondaEnum,
		...
		if (!DirecaoGiroSondaEnum.GIRAR_SONDA_DIREITA.equals(direcaoGiroSondaEnum)) {
